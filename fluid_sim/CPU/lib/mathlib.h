...
/*
    The files in lib/ were taken from the Scotty3D project for 15-662 (Computer Graphics) at Carnegie Mellon University.
    All credit for these files go to Professor Keenan Crane and his TAs.

    These files provide useful math routines for computer graphics
*/
